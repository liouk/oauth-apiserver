		...
		*/
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			c := NewAuthenticationConfigurationGenerator(
				...
				Options{
					ExternalClaimsSourcing: tt.withExternalClaimsSourcing,
				},
			)
...
func TestAuthenticationConfigurationGeneratorRejectsInvalidInputs(t *testing.T) {
	t.Run("nil authentication spec", func(t *testing.T) {
		generator := NewAuthenticationConfigurationGenerator(nil, nil, Options{})

		config, err := generator.GenerateAuthenticationConfiguration(nil)
	...
	t.Run("resolver errors retain their cause and resource name", func(t *testing.T) {
		...
		generator := NewAuthenticationConfigurationGenerator(
...
func TestGenerateExternalClaimsSourceAuthenticationClientCredentialWithoutTLS(t *testing.T) {
	generator := NewAuthenticationConfigurationGenerator(nil, func(name string) (string, error) {
